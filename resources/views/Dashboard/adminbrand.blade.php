<x-adminheader title="Brand" />
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row mb-4">
            <div class="col-lg-12">
                <div class="">
                    <a href="{{ URL::to('/dashobard')}}" class="text-black">Vendor</a><span> >> </span>
                    <a href="{{ URL::to('/adminbrand')}}" class="text-black">Brand</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ URL::to('AddNewBrand')}}" method="POST">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Enter Brand" required>
                                            @error('name')
                            ...
                            <table id="myTable" class="table display table-striped table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="modal" id="updateModel{{ $i}}" >
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ URL::to('UpdateABrand')}}" method="POST">
                                                                @csrf
                                        ...
                                        <td>
                                            <a href="{{ URL::to('deleteABrand/'.$item->id)}}" class="btn"><i class="fa-solid fa-trash-can" style="color: red;"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
