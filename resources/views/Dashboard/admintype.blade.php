                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ URL::to('AddNewType')}}" method="POST">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Enter Type" required>
                                            @error('name')
                            ...
                            <table id="myTable" class="table display table-striped table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="modal" id="updateModel{{ $i}}" >
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ URL::to('UpdateAType')}}" method="POST">
                                                                @csrf
                                                                <label for="">Name</label>
                                        ...
                                        <td>
                                            <a href="{{ URL::to('deleteAType/'.$item->id)}}" class="btn"><i class="fa-solid fa-trash-can"  style="color: red;"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
