            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class=" btn btn-success fas-sharp fas-solid fas-plus" data-toggle="modal" val data-target="#addNewModel">
                          New Category
                        </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ URL::to('AddNewCategory')}}" method="POST">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Enter Category" value="{{ old('name') }}"  @error('name') is-invalid @enderror required>
                                            @error('name')
                            ...
                            <table id="myTable" class="table display table-striped table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ URL::to('deleteCategory/'.$item->id)}}" class="btn btn"><i class="fa-solid fa-trash-can" style="color: red;"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
